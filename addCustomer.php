...
<body>
    ...
    <div class="containerMenu">
        ...
        <h1>Vas a agregar un nuevo cliente</h1><br>
         <form action="" class="loginForm2" method="POST">
                <label for="user">
                    <input type="text" name="nameCustomer" placeholder="Nombre del cliente / empresa">
                    <button name="agregar">Dar de alta</button>
                </label>
            </form>
            <?php
                if(isset($_POST['nameCustomer']) && isset($_POST['agregar'])){
                    echo "aqui agregamos al nuevo cliente...";
                }
